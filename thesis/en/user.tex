...
\lstinputlisting[caption={app.js}]{../lib/app.js}
...
\lstinputlisting[caption={comsize.js}]{../lib/comsize.js}

Now have to create the actual plugin:
\lstinputlisting[caption={size.js}]{../lib/size.js}

And now we are able to pass the newly created plugin to the \textit{Query}:
\lstinputlisting[caption={main.js}]{../lib/main.js}

By running the following program for any repository we will get a result which looks like this:
