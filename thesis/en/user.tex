...
\section{System requirements} (0.5)
\subsection{Node.js} (0.5)
\subsection{Operating system} (0.5)

\section{Installation} (1)
\subsection{From source file} (2)
\subsection{From package manager} (2)

\section{How to use the application}

\subsection{As a CLI tool} (1)
