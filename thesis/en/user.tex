...
\subsection{Use case: Who changed, what files} (0.5)
...
\subsection{Use case: A single person commits} (0.5)
...
\subsection{Use case: How many commits the authors have} (0.5)
